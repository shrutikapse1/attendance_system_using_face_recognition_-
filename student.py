...
class Student:
    def __init__(self,root) :
        ...
        main_frame.place(x=20,y=50,width=1488,height=600)
...
#       Semester
        ...
        division_combo.grid(row=1,column=1,padx=2,pady=5,sticky=W)
       ...
       # Email
        ...
        btn_frame.place(x=0,y=200,width=656,height=35)
        ...
        btn_frame1.place(x=0,y=235,width=329,height=35)
       ...
       # Table  frame
        ...
        table_frame.place(x=5,y=145,width=710,height=400)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                self.var_dep.get(),self.var_course.get(),self.var_year.get(),self.var_semester.get(),self.var_std_id.get(),self.var_std_name.get(),
            ...
            try:
                ...
                my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,Photosample=%s where id=%s",
                    (self.var_dep.get(),self.var_course.get(),self.var_year.get(),self.var_semester.get(),self.var_std_name.get(),
                     self.var_div.get(),self.var_roll.get(),self.var_gender.get(),self.var_dob.get(),self.var_email.get(),self.var_phone.get(),
                     self.var_address.get(),self.var_teacher.get(),self.var_radio1.get(),self.var_std_id.get()==id+1
                    ))
                conn.commit()
                self.fetch_data()
                self.reset_data()
