...
class Attendance:
    def __init__(self,root) :
        ...
        # 2
        img1=Image.open(r"college_images\attendance2.jpeg")
        ...
        img_left=Image.open(r"college_images\attendance matters 2.png")
        ...
        self.atten_status=ttk.Combobox(left_inside_frame,font=("times new roman",12,"bold"),state="readonly",width=20,textvariable=self.var_atten_attendance)
        ...
        btn_frame.place(x=70,y=300,width=490,height=35)
    ...
    #    To remove the unnecessary blank column
